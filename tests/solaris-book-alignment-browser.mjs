...
try{
  ...
  const links=page.locator('a[data-solaris-book-download="editorial-v7"]');
  ...
  const expected=await fs.readFile('public/forms/solaris/downloads/solaris-book-2026-v7.pdf');
