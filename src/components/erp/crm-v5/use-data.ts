...
const empty:CrmEnterpriseData={records:[],actions:[],pipelines:[],stages:[],teams:[],teamMembers:[],campaigns:[],folders:[],assets:[],automations:[],alerts:[],assignments:[],templates:[],integrations:[],goals:[]};
