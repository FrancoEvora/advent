...
export function GlobalModuleNav(){
 ...
 if(path==="/privacidade"||path==="/politica-de-privacidade"||path==="/arisa/privacidade"||path==="/arisa"||path.startsWith("/bia")||path.startsWith("/cliente/")||path.startsWith("/parceiro")||path.startsWith("/proposta/")||path.startsWith("/contrato/")||path.startsWith("/verificar/")||path.startsWith("/atendimento/"))return null;
