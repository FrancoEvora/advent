...
export function UsersView({ data, mutate }: AdminProps) {
  ...
  return <div className="stack">
    ...
    {photo && <ProfilePhotoModal data={data} profile={photo} close={() => setPhoto(null)} mutate={mutate} />}
  </div>;
}