...
export const metadata:Metadata={title:"Évora Gestão — Versão 6.3.1 Enterprise",description:"Plataforma integrada da Évora Urbanismo com OTP simulado por digitação manual, gestão de ativos restrita à aba de Marketing, Central de Ajuda, decisões financeiras com data negociada, DRE gerencial, CRM, contratos eletrônicos, pós-venda e governança.",manifest:"/manifest.webmanifest",applicationName:"Évora Gestão",icons:{icon:"/icon.svg",apple:"/icon.svg"},appleWebApp:{capable:true,statusBarStyle:"default",title:"Évora Gestão"}};
