...
export type AdminProps = { data: ErpData; mutate: (operation: () => Promise<void>, success: string) => Promise<void>; can?: (permission: string) => boolean };
export function AdminView({ mode, data, mutate, can }: AdminProps & { mode: ViewId }) {
