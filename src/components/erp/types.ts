...
export interface CrmRecord { id: string; organization_id: string; contact_id: string | null; person_name: string; company_name: string | null; email: string | null; phone: string | null; project_id: string | null; stage: string; record_status: "aberta" | "ganha" | "perdida" | "arquivada"; source: string | null; estimated_value: number; probability: number; expected_close_date: string | null; next_action_at: string | null; owner_user_id: string | null; notes: string | null; created_by: string | null; created_at: string; updated_at: string; pipeline_id?: string | null; stage_id?: string | null; team_id?: string | null; sdr_user_id?: string | null; broker_user_id?: string | null; campaign_id?: string | null; lead_score?: number; temperature?: "frio" | "morno" | "quente"; priority?: "baixa" | "normal" | "alta" | "urgente"; source_channel?: string | null; utm_source?: string | null; utm_medium?: string | null; utm_campaign?: string | null; utm_content?: string | null; landing_page?: string | null; last_contact_at?: string | null; first_response_at?: string | null; sla_due_at?: string | null; stagnation_at?: string | null; attempts?: number; tags?: string[]; budget_min?: number | null; budget_max?: number | null; preferred_area_min?: number | null; preferred_area_max?: number | null; preferred_city?: string | null; financing_interest?: boolean; payment_capacity?: number | null; lost_reason?: string | null; converted_at?: string | null; person_type?: string; cpf_cnpj?: string | null; rg_ie?: string | null; issuing_authority?: string | null; birth_date?: string | null; nationality?: string | null; marital_status?: string | null; property_regime?: string | null; occupation?: string | null; monthly_income?: number | null; spouse_name?: string | null; spouse_document?: string | null; spouse_email?: string | null; spouse_phone?: string | null; postal_code?: string | null; street?: string | null; address_number?: string | null; complement?: string | null; neighborhood?: string | null; city?: string | null; state?: string | null; country?: string | null; buyer_profile_completed_at?: string | null; }
