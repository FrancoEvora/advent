...
export const workspaceLabels: Record<WorkspacePanel, string> = {
  "whatsapp-conversations": "Conversas da Arisa via WhatsApp", leads: "Leads e funil", simulations: "Simulações", email: "E-mail", agenda: "Agenda e Meet", whatsapp: "WhatsApp", archive: "Arquivo", memory: "Memória",
};
...
export function workspaceLabel(panel: WorkspacePanel, assistant: "arisa" | "bia" = "arisa", includeAssistant = false) {
  if (panel === "whatsapp-conversations") return "Conversas da Arisa via WhatsApp";
