...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!object(body) || typeof body.slug !== "string" || typeof body.text !== "string") {
    ...
    const result = await synthesizeVitoriaSpeech({
      slug: body.slug,
      token,
    ...
    const code = error instanceof VitoriaServerError ? error.code : "VITORIA_SPEECH_UNAVAILABLE";
