...
export type ViewId = "dashboard" | "financeiro" | "caixa" | "compras" | "rh" | "documentos" | "aprovacoes" | "centros" | "cadastros" | "projetos" | "usuarios" | "relatorios" | "auditoria" | "configuracoes";
...
export interface HrEvent { id: string; organization_id: string; employee_id: string; event_type: "adiantamento" | "ferias" | "decimo_terceiro" | "bonus" | "desconto" | "afastamento" | "desligamento" | "outro"; reference_date: string; due_date: string | null; amount: number; status: "previsto" | "aprovado" | "pago" | "cancelado"; cash_flow_impact: boolean; notes: string | null; created_by: string | null; approved_by: string | null; approved_at: string | null; created_at: string; }
export interface HrPayrollRun { id: string; organization_id: string; reference_month: string; payment_date: string; status: "rascunho" | "calculada" | "aprovada" | "paga" | "cancelada"; gross_total: number; charges_total: number; benefits_total: number; advances_total: number; net_total: number; projected_cash_balance: number | null; recommended_payment_date: string | null; cash_risk: boolean; approved_by: string | null; approved_at: string | null; created_by: string | null; created_at: string; updated_at: string; }
...
export interface ErpData {
  ...
  documents: DocumentAttachment[]; purchaseRequests: PurchaseRequest[]; purchaseItems: PurchaseRequestItem[];
  hrEmployees: HrEmployee[]; hrEvents: HrEvent[]; hrPayrollRuns: HrPayrollRun[]; hrPayrollItems: HrPayrollItem[];
}