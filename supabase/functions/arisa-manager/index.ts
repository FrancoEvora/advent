...
const ERRORS: Record<string, string> = {
  ...
  ARISA_PROVIDER_LIMIT: "A OpenAI recusou a solicitação por limite de uso ou cota. Confira a integração de IA. Sua mensagem está salva.",
  ARISA_PROVIDER_QUOTA: "A conta OpenAI conectada está sem cota disponível para a API. Confira o saldo, o faturamento e o limite de uso dessa conta. Sua mensagem está salva para retomar após a regularização.",
  ARISA_PROVIDER_RATE_LIMIT: "A OpenAI limitou o volume de solicitações ou tokens neste momento. Aguarde um pouco e retome esta mensagem. Se persistir, confira os limites do modelo na conta conectada.", ARISA_TIMEOUT: "A análise excedeu o tempo disponível. Você pode retomar esta mensagem; as ações já registradas serão preservadas.",
