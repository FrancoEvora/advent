...
export function MarketingManagementV63({context,focus=null}:{context:Context;focus?:ActivityDeepLinkTarget|null}){
 ...
 return <div className="marketing-v63-shell" onClickCapture={interceptAssetAction}>
  <MarketingManagementV60 key={revision} context={context} focus={focus}/>
