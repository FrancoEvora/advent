...
export interface CrmCampaign { id:string; organization_id:string; name:string; campaign_type:string; channel:string|null; status:string; project_id:string|null; owner_user_id:string|null; budget:number; spent:number; start_date:string|null; end_date:string|null; objective:string|null; audience:string|null; utm_source:string|null; utm_medium:string|null; utm_campaign:string|null; landing_page:string|null; notes:string|null; created_at:string; updated_at:string; }
