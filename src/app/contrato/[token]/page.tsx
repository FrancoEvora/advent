...
const consentText="Declaro que li e compreendi este contrato e o assino eletronicamente, concordando com seu conteúdo e com o plano de pagamento apresentado.";
 ...
 return <main className="public-proposal public-contract">
  ...
  <section className="e-sign-panel">
   ...
   <form onSubmit={accept}>
    ...
    <p>A assinatura registra timestamp, IP, navegador, hash do documento e, somente mediante autorização, localização do dispositivo.</p>
