...
export const SOLARIS_EDITORIAL_BOOK_URL = "/forms/solaris/downloads/solaris-book-2026-v7.pdf";
...
export function SolarisBookLink({ className, children, edition = "institutional" }: { className?: string; children: ReactNode; edition?: "institutional" | "editorial" }) {
  ...
  return (
    <a className={className} href={editorial ? SOLARIS_EDITORIAL_BOOK_URL : SOLARIS_BOOK_DOWNLOAD_URL} download={editorial ? "Solaris_Seus_Proximos_Vizinhos_2026.pdf" : "Solaris_Book_2026_V6.pdf"} target="_blank" rel="noopener noreferrer" data-solaris-book-download={editorial ? "editorial-v7" : "v6"} title={editorial ? "Seus próximos vizinhos · Edição editorial 2026 · 28 páginas · 22 MB" : "Book comercial Solaris 2026 V6 · PDF completo · 23 páginas · 32 MB"}>
