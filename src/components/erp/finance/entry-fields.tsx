...
export function EntryFields({ data, revenueCenters, entry, entryType, setEntryType, amountChanged, dueDate, setDueDate, scheduledPaymentDate, setScheduledPaymentDate, accountId, setAccountId, contactId, setContactId, contacts, openContact }: {
  data: ErpData;
  ...
  setScheduledPaymentDate: (value: string) => void;
  accountId: string;
