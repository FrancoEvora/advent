...
export const metadata:Metadata={title:"Évora Gestão — Versão 6.1 Enterprise",description:"Plataforma integrada da Évora Urbanismo com OTP de teste controlado, Marketing Operating System, DRE gerencial, CRM, contratos eletrônicos, pós-venda, portal comercial do cliente, governança e recuperação.",manifest:"/manifest.webmanifest",applicationName:"Évora Gestão",icons:{icon:"/icon.svg",apple:"/icon.svg"},appleWebApp:{capable:true,statusBarStyle:"default",title:"Évora Gestão"}};
