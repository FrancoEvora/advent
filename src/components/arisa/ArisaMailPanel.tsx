...
type Status = { configured: boolean; connected: boolean; sender_email: string; connected_email: string | null; client_id: string | null; redirect_uri: string; last_sync_at: string | null; sync_error: string | null };
...
export default function ArisaMailPanel({ organizationId, userId }: { organizationId: string; userId: string }) {
  ...
  async function connect() {
    const result = await perform("connect");
