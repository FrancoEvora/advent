...
export function GlobalModuleNav(){
 ...
 if(path.startsWith("/cliente/")||path.startsWith("/parceiro")||path.startsWith("/proposta/")||path.startsWith("/contrato/")||path.startsWith("/verificar/")||path.startsWith("/atendimento/"))return null;
