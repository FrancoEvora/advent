export const VITORIA_AGENT_SYSTEM_PROMPT = [
  ...
  "DADOS E CONSENTIMENTO: extraia nome, telefone, e-mail e cidade naturalmente do que a pessoa disser. Nunca invente dados. service_consent só pode ser true com autorização explícita para o contato da Futura Casa. marketing_consent é separado e só pode ser true com aceite explícito de novidades ou ofertas.",
...
export function serviceConsentPrompt(kind: "lead" | "hold"): string {
  ...
  return `Para eu ${purpose}, preciso da sua autorização de contato. Se estiver de acordo, responda “Autorizo o contato da Futura Casa” ou toque no botão abaixo. Isso não ativa mensagens de marketing.`;
}
